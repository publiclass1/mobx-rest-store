...
var Collection = exports.Collection = (_class = function () {
  ...
  (0, _createClass3.default)(Collection, [{
    ...
    value: function get(id) {
      ...
      var requestToServer = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;


      var model = null;
      if (!requestToServer) {
        model = this.findWhere((0, _defineProperty5.default)({}, this.getIdName(), id));
        if (model) {
          return _promise2.default.resolve(model);
        }
      }
